...
for a in range(0,5):
    ...
    #Combine in ensemble 
    Y_pred = VotingClassification(estimators=[('svm', modelSVM), ('lr',modelLR), ('GNB', modelGNB), ('NN', modelNN)], voting='hard', weights=(weight_SVM,weight_LR,weight_GNB,weight_NN), n_jobs=None, flatten_transform=True)
